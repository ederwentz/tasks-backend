...
//                SonarToken = '5bdeeabb24ad3efb373575cb8dc54b90d88dfea3'
            ...
            steps {
                withSonarQubeEnv('SONAR_LOCAL') {
                   bat "${scannerHome}/bin/sonar-scanner -e -Dproject.settings=C:\\Users\\Eder Wentz\\.jenkins\\tools\\hudson.plugins.sonar.SonarRunnerInstallation\\SONAR_SCANNER\\config\\sonar-scanner.properties"
