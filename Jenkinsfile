        ...
        stage ('Sonar Analysis') {
            ...
            steps {
                withSonarQubeEnv('SONAR_LOCAL') {
                    bat "${scannerHome}/bin/sonar-scanner.bat -e -Dsonar.host.url=http://localhost:9000/${SonarToken} -Dsonar.login=cc9493e93b46c74ad9ec3c4889cb6157766f29d6 -Dsonar.projectKey=Deploy-Backend -Dsonar.host.url=http://localhost:9000 -Dsonar.projectBaseDir=C:\\Users\\Eder Wentz\\.jenkins\\workspace\\Deploy Backend -Dsonar.java.binaries=target -Dsonar.coverage.exclusions=**/.mvn/**, **/scr/test/**,**/model/**,**Application.java"
