...
//                    sh "mvn clean package sonar:sonar -Dsonar.projectKey=DeployBackend -Dsonar.login=e89f6b58d5a145cd62c7c08d1ad06d07fb9ca9c0 -Dsonar.java.binaries=target -Dsonar.coverage.exclusions=**/.mvn/**,**/scr/test/**,**/model/**,**Application.java"
                    sh "mvn clean verify -Dsonar.projectKey=DeployBackend Dsonar.host.url=http://192.168.1.118:9000 -Dsonar.login=a5d7a261967227a2f339806efb7c4dd6550424c2 -Dsonar.java.binaries=target -Dsonar.coverage.exclusions=**/.mvn/**,**/scr/test/**,**/model/**,**Application.java"
